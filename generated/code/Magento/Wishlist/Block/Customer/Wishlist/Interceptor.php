...
class Interceptor extends \Magento\Wishlist\Block\Customer\Wishlist implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setOptionsRenderCfgs');
        if (!$pluginInfo) {
            return parent::setOptionsRenderCfgs($optionCfg);
        } else {
            return $this->___callPlugins('setOptionsRenderCfgs', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOptionsRenderCfgs');
        if (!$pluginInfo) {
            return parent::getOptionsRenderCfgs();
        } else {
            return $this->___callPlugins('getOptionsRenderCfgs', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addOptionsRenderCfg');
        if (!$pluginInfo) {
            return parent::addOptionsRenderCfg($productType, $helperName, $template);
        } else {
            return $this->___callPlugins('addOptionsRenderCfg', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOptionsRenderCfg');
        if (!$pluginInfo) {
            return parent::getOptionsRenderCfg($productType);
        } else {
            return $this->___callPlugins('getOptionsRenderCfg', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDetailsHtml');
        if (!$pluginInfo) {
            return parent::getDetailsHtml($item);
        } else {
            return $this->___callPlugins('getDetailsHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddToCartQty');
        if (!$pluginInfo) {
            return parent::getAddToCartQty($item);
        } else {
            return $this->___callPlugins('getAddToCartQty', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddAllToCartParams');
        if (!$pluginInfo) {
            return parent::getAddAllToCartParams();
        } else {
            return $this->___callPlugins('getAddAllToCartParams', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getWishlistItems()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getWishlistItems', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWishlistInstance');
        if (!$pluginInfo) {
            return parent::getWishlistInstance();
        } else {
            return $this->___callPlugins('getWishlistInstance', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemRemoveParams');
        if (!$pluginInfo) {
            return parent::getItemRemoveParams($item);
        } else {
            return $this->___callPlugins('getItemRemoveParams', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemAddToCartParams');
        if (!$pluginInfo) {
            return parent::getItemAddToCartParams($item);
        } else {
            return $this->___callPlugins('getItemAddToCartParams', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSharedItemAddToCartUrl');
        if (!$pluginInfo) {
            return parent::getSharedItemAddToCartUrl($item);
        } else {
            return $this->___callPlugins('getSharedItemAddToCartUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSharedAddAllToCartUrl');
        if (!$pluginInfo) {
            return parent::getSharedAddAllToCartUrl();
        } else {
            return $this->___callPlugins('getSharedAddAllToCartUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemConfigureUrl');
        if (!$pluginInfo) {
            return parent::getItemConfigureUrl($product);
        } else {
            return $this->___callPlugins('getItemConfigureUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEscapedDescription');
        if (!$pluginInfo) {
            return parent::getEscapedDescription($item);
        } else {
            return $this->___callPlugins('getEscapedDescription', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasDescription');
        if (!$pluginInfo) {
            return parent::hasDescription($item);
        } else {
            return $this->___callPlugins('hasDescription', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFormatedDate');
        if (!$pluginInfo) {
            return parent::getFormatedDate($date);
        } else {
            return $this->___callPlugins('getFormatedDate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWishlistItemsCount');
        if (!$pluginInfo) {
            return parent::getWishlistItemsCount();
        } else {
            return $this->___callPlugins('getWishlistItemsCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasWishlistItems');
        if (!$pluginInfo) {
            return parent::hasWishlistItems();
        } else {
            return $this->___callPlugins('hasWishlistItems', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getProductUrl($item, $additional = [])
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductUrl($item, $additional);
        } else {
     ...
     * {@inheritdoc}
     */
    public function getItemPriceHtml(\Magento\Catalog\Model\Product\Configuration\Item\ItemInterface $item, $priceType = 'configured_price', $renderZone = 'item_list', array $arguments = [])
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemPriceHtml');
        if (!$pluginInfo) {
            return parent::getItemPriceHtml($item, $priceType, $renderZone, $arguments);
        } else {
            return $this->___callPlugins('getItemPriceHtml', func_get_args(), $pluginInfo);
        }
    }
