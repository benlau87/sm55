...
class Interceptor extends \Magento\Wishlist\Block\Customer\Wishlist\Item\Column\Image implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductForThumbnail');
        if (!$pluginInfo) {
            return parent::getProductForThumbnail($item);
        } else {
            return $this->___callPlugins('getProductForThumbnail', func_get_args(), $pluginInfo);
        }
    }
