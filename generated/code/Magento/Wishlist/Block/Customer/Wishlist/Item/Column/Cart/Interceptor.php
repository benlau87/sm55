...
class Interceptor extends \Magento\Wishlist\Block\Customer\Wishlist\Item\Column\Cart implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductItem');
        if (!$pluginInfo) {
            return parent::getProductItem();
        } else {
            return $this->___callPlugins('getProductItem', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getJs');
        if (!$pluginInfo) {
            return parent::getJs();
        } else {
            return $this->___callPlugins('getJs', func_get_args(), $pluginInfo);
        }
    }
