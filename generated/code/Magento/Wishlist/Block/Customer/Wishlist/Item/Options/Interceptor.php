...
class Interceptor extends \Magento\Wishlist\Block\Customer\Wishlist\Item\Options implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Framework\App\Http\Context $httpContext, \Magento\Catalog\Helper\Product\ConfigurationPool $helperPool, array $data = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConfiguredOptions');
        if (!$pluginInfo) {
            return parent::getConfiguredOptions();
        } else {
            return $this->___callPlugins('getConfiguredOptions', func_get_args(), $pluginInfo);
        }
    }
