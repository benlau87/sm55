<?php
namespace Magento\CheckoutAgreements\Model\Agreement;

/**
 * Interceptor class for @see \Magento\CheckoutAgreements\Model\Agreement
 */
class Interceptor extends \Magento\CheckoutAgreements\Model\Agreement implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function validateData($agreementData)
    {
        ...
        if (!$pluginInfo) {
            return parent::validateData($agreementData);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAgreementId');
        if (!$pluginInfo) {
            return parent::getAgreementId();
        } else {
            return $this->___callPlugins('getAgreementId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setAgreementId');
        if (!$pluginInfo) {
            return parent::setAgreementId($id);
        } else {
            return $this->___callPlugins('setAgreementId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContentHeight');
        if (!$pluginInfo) {
            return parent::getContentHeight();
        } else {
            return $this->___callPlugins('getContentHeight', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setContentHeight');
        if (!$pluginInfo) {
            return parent::setContentHeight($height);
        } else {
            return $this->___callPlugins('setContentHeight', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCheckboxText');
        if (!$pluginInfo) {
            return parent::getCheckboxText();
        } else {
            return $this->___callPlugins('getCheckboxText', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setCheckboxText');
        if (!$pluginInfo) {
            return parent::setCheckboxText($text);
        } else {
            return $this->___callPlugins('setCheckboxText', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setIsActive($status)
    {
        ...
        if (!$pluginInfo) {
            return parent::setIsActive($status);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIsHtml');
        if (!$pluginInfo) {
            return parent::getIsHtml();
        } else {
            return $this->___callPlugins('getIsHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIsHtml');
        if (!$pluginInfo) {
            return parent::setIsHtml($isHtml);
        } else {
            return $this->___callPlugins('setIsHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setMode');
        if (!$pluginInfo) {
            return parent::setMode($mode);
        } else {
            return $this->___callPlugins('setMode', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function setExtensionAttributes(\Magento\CheckoutAgreements\Api\Data\AgreementExtensionInterface $extensionAttributes)
    {
