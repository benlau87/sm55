...
class Interceptor extends \Algolia\AlgoliaSearch\Helper\Image implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\Helper\Context $context, \Magento\Catalog\Model\Product\ImageFactory $productImageFactory, \Magento\Framework\View\Asset\Repository $assetRepo, \Magento\Framework\View\ConfigInterface $viewConfig, \Algolia\AlgoliaSearch\Helper\Logger $logger, $options = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'removeProtocol');
        if (!$pluginInfo) {
            return parent::removeProtocol($url);
        } else {
            return $this->___callPlugins('removeProtocol', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'removeDoubleSlashes');
        if (!$pluginInfo) {
            return parent::removeDoubleSlashes($url);
        } else {
            return $this->___callPlugins('removeDoubleSlashes', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'removePubDirectory');
        if (!$pluginInfo) {
            return parent::removePubDirectory($url);
        } else {
            return $this->___callPlugins('removePubDirectory', func_get_args(), $pluginInfo);
        }
    }
