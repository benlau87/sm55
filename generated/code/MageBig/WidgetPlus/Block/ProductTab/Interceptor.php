<?php
namespace MageBig\WidgetPlus\Block\ProductTab;

/**
 * Interceptor class for @see \MageBig\WidgetPlus\Block\ProductTab
 */
class Interceptor extends \MageBig\WidgetPlus\Block\ProductTab implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'initializeProductTab');
        if (!$pluginInfo) {
            return parent::initializeProductTab($value);
        } else {
            return $this->___callPlugins('initializeProductTab', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWidgetId');
        if (!$pluginInfo) {
            return parent::getWidgetId();
        } else {
            return $this->___callPlugins('getWidgetId', func_get_args(), $pluginInfo);
        }
    }
