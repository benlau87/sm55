<?php
namespace MageBig\WidgetPlus\Block\Crosssell;

/**
 * Interceptor class for @see \MageBig\WidgetPlus\Block\Crosssell
 */
class Interceptor extends \MageBig\WidgetPlus\Block\Crosssell implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemCount');
        if (!$pluginInfo) {
            return parent::getItemCount();
        } else {
            return $this->___callPlugins('getItemCount', func_get_args(), $pluginInfo);
        }
    }
